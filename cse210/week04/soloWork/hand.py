class Hand(object):
    ...
    def __init__(self):
        self.cards = [] # cards is list of Card objects

    def __str__(self): # meth retruns string for entrie hand
        if self.cards:
           reply = ""
           for card in self.cards:
            ...
            reply = "<empty>"
        return reply
    def clear(self): # clears list of cards 
        self.cards = []

    def add(self, card): # adds card to list of cards
        self.cards.append(card)

    def give(self, card, other_hand): # removes cards from current hand and adds to anotehr hand
