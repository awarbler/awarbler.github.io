...
// changed the zip code to whatever town **** for assignment changed  i used city id not zip code
// then a comma with us&app= then type api key from openWeatherMap copy example below 
// toggle word wrap
// type true to 
// add protocall and type https:// or // before api
// to add f temp add & units imperial

weatherObject.open( "GET", "//api.openweathermap.org/data/2.5/weather?id=2172797,us&appid=73cd33c03f2980c4fbeb11973fc5f602&units=imperial", true);
